...
contract L2OutputOracle is Initializable, ISemver {
    ...
    NitroEnclavesManager public immutable nitroEnclavesManager;
    ...
    constructor(NitroEnclavesManager _nitroEnclavesManager) {
        nitroEnclavesManager = _nitroEnclavesManager;
        initialize({
    ...
    function latestL2Output() public view returns (Types.OutputProposal memory) {
        return l2Outputs[l2Outputs.length - 1];
    }
