...
import {SafeCall} from "@opbnb-bedrock/src/libraries/SafeCall.sol";
...
import {SecureMerkleTrie} from "@opbnb-bedrock/src/libraries/trie/SecureMerkleTrie.sol";
import {Predeploys} from "@opbnb-bedrock/src/libraries/Predeploys.sol";
import {AddressAliasHelper} from "@opbnb-bedrock/src/vendor/AddressAliasHelper.sol";
import "@opbnb-bedrock/src/libraries/PortalErrors.sol";
...
contract Portal is Initializable, ResourceMetering, ISemver {
    ...
    ///         Reverts if the call to l2OutputOracle.getL2Output reverts.
